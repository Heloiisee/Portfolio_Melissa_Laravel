        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('admin.certifications.store') }}" enctype="multipart/form-data">
                    ...
                    {{-- PDF --}}
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-100">Fichier PDF (optionnel)</label>
                        <input type="file" name="pdf" accept="application/pdf" class="w-full mt-1 p-2 border rounded dark:bg-gray-700 dark:text-white">
