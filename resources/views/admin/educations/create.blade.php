<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Ajouter un parcours scolaire') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 shadow sm:rounded-lg">
                <form method="POST" action="{{ route('admin.educations.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="titre" value="{{ old('titre') }}" required class="w-full mt-1 p-2 border rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="etablissement" value="{{ old('etablissement') }}" required class="w-full mt-1 p-2 border rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="date_debut" value="{{ old('date_debut') }}" required class="w-full mt-1 p-2 border rounded">
                        @error('date_debut') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Date de fin (optionnel)</label>
                        <input type="date" name="date_fin" value="{{ old('date_fin') }}" class="w-full mt-1 p-2 border rounded">
